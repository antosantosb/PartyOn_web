    ...
    <div className="min-h-screen bg-[#0c0c0c] text-white p-6 font-mono selection:bg-[#e63329]/30">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b-2 border-white/10 pb-6 mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-black uppercase text-white tracking-tight">
            Equipo <span className="text-[#e63329]">/ System Users</span>
          </h1>
          <p className="text-white/40 text-xs mt-1">Gestión de administradores y personal con acceso al backoffice</p>
        </div>
        <button
          onClick={() => setCreateOpen(true)}
          className="brut-btn select-none rounded-none border-2 border-[#e63329] bg-[#e63329] text-white hover:shadow-[4px_4px_0_0_rgba(255,255,255,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all"
        >
      ...
      <div className="bg-[#111] border-2 border-white/10 rounded-none overflow-hidden">
        {loading ? (
          <div className="flex items-center justify-center py-20 text-white/30 gap-2">
            <Loader2 className="w-5 h-5 animate-spin text-[#e63329]" />
                ...
                {users.map((u) => (
                  <tr key={u.id} className="hover:bg-white/2 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className={`px-2 py-1 text-[10px] font-bold border rounded-none tracking-wider ${
                        u.role === 'DEV' ? 'bg-purple-500/10 text-purple-400 border-purple-500/40' :
                        u.role === 'ADMIN' ? 'bg-[#e63329]/10 text-[#e63329] border-[#e63329]/40' :
                    ...
                    <td className="px-6 py-4 text-right space-x-2">
                      <button
                        ...
                        className="p-2 border-2 border-white/10 text-white hover:border-[#e63329] hover:text-[#e63329] transition-colors rounded-none"
      ...
      {createOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-xs">
          <div className="w-full max-w-md bg-[#0d0d0d] border-2 border-white p-6 relative rounded-none shadow-[8px_8px_0_0_rgba(230,51,41,0.2)]">
            <button
            ...
            <form onSubmit={createForm.handleSubmit(onCreateSubmit)} className="space-y-4 text-left">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#121212] border-2 border-white/10 focus:border-[#e63329] p-3 text-white text-sm focus:outline-none transition-colors rounded-none"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-[#121212] border-2 border-white/10 focus:border-[#e63329] p-3 text-white text-sm focus:outline-none transition-colors rounded-none appearance-none"
                >
              ...
              <div className="pt-4 flex gap-3">
                <button
                  type="submit"
                  className="flex-1 brut-btn border-2 border-[#e63329] bg-[#e63329] text-white py-3 rounded-none hover:shadow-[4px_4px_0_0_rgba(255,255,255,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all"
                >
                  Crear Usuario
                </button>
                <button
      ...
      {resetUser && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-xs">
          <div className="w-full max-w-md bg-[#0d0d0d] border-2 border-white p-6 relative rounded-none shadow-[8px_8px_0_0_rgba(230,51,41,0.2)]">
            ...
            <p className="text-white/40 text-xs mb-6">Restablecer la contraseña para {resetUser.name} ({resetUser.email})</p>
